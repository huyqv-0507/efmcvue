    ...
    <div class="p-col-12 flexbox-demo">
      <div>
        ...
        <p>
          ...
          FlexBox utilities. If you require a utility to manage the layout of
...
&lt;div class="p-d-inline-flex"&gt;Inline Flex Container&lt;/div&gt;
        ...
        <h5>Direction</h5>
        <p>
          Default is applied using the <i>p-flex-{direction}</i> class where
...
&lt;/div&gt;
        ...
        <p>
          ...
          <i>p-order-{value}</i> format is used where value can be a number from
          0 to 6.
        </p>
...
&lt;/div&gt;
        ...
        <h5>Wrap</h5>
        <p>
          Flex wrap defines the wrap behavior when there is not enough space in
          the container. The format of the class is <i>p-flex-{value}</i> and
          the value field can be either of the listed alternatives.
        </p>
...
&lt;/div&gt;
        ...
        <p>
          Justify content is the alignment along the main axis and defined using
          the <i>p-jc-{value}</i> format with responsive alternatives. Value
          field accepts the options below.
        </p>
        <ul>
          <li>start</li>
          <li>end</li>
...
&lt;/div&gt;
        ...
        <h5>Align Items</h5>
        <p>
          Align Items configuration is the alignment along the cross axis and
          defined using the <i>p-ai-{value}</i> format with responsive
...
&lt;/div&gt;
        ...
        <h5>Align Self</h5>
        <p>
          Align self configuration is the alignment along the cross axis for a
          particular element and defined using the <i>p-as-{value}</i> format
          with responsive alternatives. Value field accepts the options below.
        </p>
        <ul>
          <li>start</li>
          <li>end</li>
...
&lt;/div&gt;
        ...
        <h5>Align Content</h5>
        <p>
          Align content is the alignment along the cross axis and defined using
          the <i>p-ac-{value}</i> format with responsive alternatives. Value
          field accepts the options below.
        </p>
        <ul>
          <li>start</li>
