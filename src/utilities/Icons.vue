<template>
  <div class="card icons-demo">
    <h4>Icons</h4>
    <p>Freya uses PrimeIcons v4.1, PrimeTek's new modern icon library.</p>

    <h5>Getting Started</h5>
    <p>
      PrimeIcons use the <strong>pi pi-{icon}</strong> syntax such as
      <strong>pi pi-check</strong>. A standalone icon can be displayed using an
      element like <i>i</i> or <i>span</i>.
    </p>
    <pre v-code><code>
...
&lt;i class="pi pi-times"&gt;&lt;/i&gt;
    ...
    <p>
      Components that have icon properties accept PrimeIcons with the
      <strong>pi pi-{icon}</strong> syntax.
    </p>
    <pre v-code><code>
...
&lt;i class="pi pi-spin pi-spinner" style="fontSize: 2rem"&gt;&lt;/i&gt;
    ...
    <h5>List of Icons</h5>
    <p>
      Here is the current list of PrimeIcons, more icons are added periodically.
      You may also
