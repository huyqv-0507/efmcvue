      ...
      <div class="p-grid">
          ...
          <div class="p-grid">
            ...
            <div class="p-col-12">
              <div class="notification">
                <h6>
                  👋 Hello! Welcome to Hit! Before start please complete your
                  profile to know you better.
                  <a href="#"
                    >Profile settings <i class="pi pi-arrow-up"></i
                  ></a>
                </h6>
              </div>
            </div>
          ...
          <div class="card chat">
            ...
            <TabView>
              <TabPanel>
                <template #header>
                  <img
                    src="assets/demo/images/rightpanel/profile-1.png"
                    alt="freya-layout"
                  />
              ...
              <TabPanel>
                <template #header>
                  <img
                    src="assets/demo/images/rightpanel/profile-2.png"
                    alt="freya-layout"
                  />
              ...
              <TabPanel>
                <template #header>
                  <img
                    src="assets/demo/images/rightpanel/profile-3.png"
                    alt="freya-layout"
                  />
                </template>
                <div class="chat">
              ...
              <TabPanel>
                <template #header>
                  <img
                    src="assets/demo/images/rightpanel/profile-4.png"
                    alt="freya-layout"
                  />
                </template>
                <div class="chat">
        ...
        <div class="p-col-12 p-md-3">
          <div class="card image-card">
            ...
            <img
              src="assets/demo/images/dashboard/asset-image.jpg"
              alt="freya-layout"
            />
            <div class="image-content">
              <h6>Shared team pictures</h6>
              <p>
                Work can be overwhelming, so we need to take time and do
                activities. See who is doing in other officess!
              </p>
