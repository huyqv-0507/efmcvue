    ...
    <div class="p-grid">
      <div class="p-col-12">
        <div class="notification">
            ...
            <p style="magin-top: 1em;"><strong>Cơ sở:</strong> {{pharmacy.name}}</p>
            <p><strong>Địa chỉ:</strong> {{pharmacy.address}}</p>
            <p><strong>Trạng thái:</strong>
				<span v-if="pharmacy.status === 'Activate'"> Đang hoạt động</span>
				<span v-else-if="pharmacy.status === 'Inactivate'"> Ngưng hoạt động</span>
				<span v-else-if="pharmacy.status === 'Block'"> Đã khoá</span>
			</p>
        </div>
      </div>
        ...
        <div class="p-grid">
          ...
          <div class="p-col">
            <div class="card overview-box gray">
              <div class="overview-info">
                <h6>Đơn thuốc đã hoàn thành nợ</h6>
                <h1>0</h1>
              </div>
          ...
          <div class="p-col">
            <div class="card overview-box darkgray">
              <div class="overview-info">
                <h6>Số lượng thuốc trong kho</h6>
                <h1>0</h1>
              </div>
          ...
          <div class="p-col">
            <div class="card overview-box orange">
              <div class="overview-info">
                <h6>Số lượng dược sĩ</h6>
                <h1>{{pharmacy.userPharmacies.length}}</h1>
              </div>
...
export default {
	computed: {
		...mapState('authentication', ['auth']),
		...mapState('pharmacies', ['pharmacy']),
		...mapState('users', ['user'])
	},
	data () {
		return {
	...
	mounted () {
		this.refreshChart()
		// this.getPharmacy(this.$route.params.pharmacyId)
	},
	methods: {
		...mapActions('pharmacies', ['getPharmacy']),
		refreshChart () {
