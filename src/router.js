...
const routes = [
  ...
  },
  {
    path: '/pharmacy-store',
    name: 'pharmacy-store',
    component: () => import('./pages/pharmacy/PharmacyStore.vue'),
    meta: {
      breadcrumb: [{ parent: 'pharmacy-store', label: 'New Pharmacy' }]
    }
  },
  {
    path: '/pharmacy-store/pharmacy-detail/:pharmacyId',
    name: 'pharmacy-detail',
    component: () => import('./pages/pharmacy/PharmacyDetail.vue'),
    meta: {
      breadcrumb: [{ parent: 'pharmacy-detail', label: 'Chi tiết' }]
    }
  },
  {
    path: '/industry-medication',
    name: 'industry-medication',
    component: () => import('./pages/pharmacy/IndustryMedication.vue'),
    meta: {
      breadcrumb: [{ parent: 'industry-medication', label: 'Danh mục thuốc' }]
    }
  },
  {
    path: '/consignment-import',
    name: 'consignment-import',
    component: () => import('./pages/consignment/ConsignmentImport.vue'),
    meta: {
      breadcrumb: [{ parent: 'consignment-import', label: 'Danh mục thuốc' }]
    }
  },
  {
    path: '/formlayout',
